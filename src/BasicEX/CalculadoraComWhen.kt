...
fun main() {
    while (true) {
        if (menu == 0) {
            ...
            when (operacao) {
                1 -> print("O resultado da soma: $num1 + $num2 é igual a " + soma(num1, num2))
                2 -> print("O resultado da multiplicação: $num1 * $num2 é igual a " + multi(num1, num2))
                3 -> print("O resultado da divisão: $num1 / $num2 é igual a " + divisao(num1, num2))
